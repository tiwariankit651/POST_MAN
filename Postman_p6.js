...
//json placeholder rest fake api
//random api .me
...
addParam.addEventListener('click', () => {
    ...
    //Add an event listerner to remove the parameter on clicking - button
...
submit.addEventListener('click', () => {
   ...
   // document.getElementById('responseJsonText').value = "Please wait.....fetching response..";
    ...
    //If user has select params option instead of json,collect all the parameters in an object
    ...
    // log all the values in console for debuggging
    console.log('URL is', url);
    console.log('requestType is', requestType);
    console.log('contentType is', contentType);
    console.log('data is', data);

//if the request type is post ,invole fetch api to create a post request
    if(requestType=='GET'){
        fetch(url,{
            method:'GET',
        })
